...
if (isset($_SESSION['user_id'])) {
    ...
    try {
        $stmt = $bd->prepare('SELECT id, correo, contrasena FROM usuarios WHERE id = :id');
        $stmt->bindParam(':id', $_SESSION['user_id']);
        $stmt->execute();

        $user = $stmt->fetch(PDO::FETCH_ASSOC);

        // Puedes usar el operador ternario para simplificar la asignación
        $user = $user ? $user : null;

    } catch (PDOException $e) {
        // Manejar errores de base de datos
        echo "Error al conectar a la base de datos: " . $e->getMessage();
        // Puedes decidir si debes detener la ejecución o tomar otra acción en caso de error
    } finally {
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./login.php">Ejercitate
                            con tu perro</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="./login.php">Etapas de vida</a></li>
                            <li><a class="dropdown-item" href="./login.php">Alimentos
                                    dañinos</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="./login.php">Enfermedades</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./login.php">Vacunas</a>
                    </li>
                </ul>
            </div>
            <ul class="navbar-nav me-3 mb-2 mb-lg-0">
                ...
                <div class="d-grid">
                    <button type="button" class="btn btn-warning">
                        <a style="text-decoration: none;" class="text-reset" href="./login.php">Iniciar sesión</a>
                    </button>
                </div>
            </ul>
        </div>
